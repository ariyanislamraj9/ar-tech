      ...
      <div className="sidemenu-content" ref={contentRef}>
        ...
        <div className="widget">
          <div className="gt-widget-about">
            ...
            <p className="text">
              Best Digital Marketing Startup Agency on Bangladesh
            </p>
          </div>
        </div>
        <div className="widget">
          ...
          <div className="gt-widget-contact">
            <div className="info-box_text">
              ...
              <div className="details">
                <p>Amodpur,Jahangirabad,Pirganj</p>
            ...
            <div className="info-box_text">
              ...
              <div className="details">
                <p>
                  <a href="tel:+8801839600629" className="info-box_link">
                    +8801839600629
                  </a>
                </p>
                <p>
                  <a href="tel:+8801810912990" className="info-box_link">
                    +8801810912990
                  </a>
                </p>
              </div>
            ...
            <div className="info-box_text">
              ...
              <div className="details">
                <p>
                  <a
                    href="mailto:support@ariyanislamraj.com"
                    className="info-box_link"
                  >
                    support@ariyanislamraj.com
                  </a>
                </p>
                <p>
                  <a
                    href="mailto:contact@ariyanislamraj.com"
                    className="info-box_link"
                  >
