                ...
                >
                  <div className="gt-widget-about">
                    ...
                    <p className="about-text">
                      AR Tech Digital Marketing Startup Agency on Bangladesh
                    </p>
                ...
                >
                  ...
                  <div className="checklist">
                    <ul className="ps-0">
                      ...
                      <li className="text-white"><a href="mailto:contact@ariyanislamraj.com">contact@ariyanislamraj.com</a></li>                    </ul>
                    <ul className="ps-0">
                      <li className="text-white">
                        <i className="fa-light fa-phone-volume" />
                      </li>
                      <li className="text-white">+8801839600629</li>
                    </ul>
                    <form
                      ref={form}
                      onSubmit={sandMail}
